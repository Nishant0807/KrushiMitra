      ...
      <div className="flex flex-col justify-center items-center mx-20 mt-10 max-sm:mx-5">
        <div className="flex  justify-between w-full items-center my-1">
          ...
          <div className="flex flex-col gap-2">
            <Link
              to="/"
              className="flex items-center gap-1 lg:text-2xl text-sm font-bold text-lightred cursor-pointer"
              style={{ fontFamily: "Vestige Grotesk" }}
            >
              {" "}
              <img
                src={logo}
        ...
        <div className="flex justify-between w-full items-center py-4">
          ...
          <div className="text-base font-poppins text-lightgray max-sm:text-xs">
            Created by <a href="https://cn-portfolio-seven.vercel.app/">Nishant Chaudhary </a> | © 2024 Krushi Mitra
          </div>
          {/* Social Media */}
